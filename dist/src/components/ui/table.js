...
function TableRow({ className, variant, ...props }) {
    return (_jsx("tr", { "data-slot": "table-row", className: cn("border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted", className, variant === "striped" ? "bg-muted/50 even:bg-transparent" : "data-[state=selected]:bg-muted"), ...props }));
}
