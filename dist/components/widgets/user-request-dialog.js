...
export function UserRequestDialog({ open, onOpenChange, onConfirm, users, availableRoles, defaultRole, title = "Select Users", description = "Search and select users to request permissions for", }) {
