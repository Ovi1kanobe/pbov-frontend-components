...
function Sidebar({ onLogout, routes, userName, isDarkMode, setDarkMode, logoSrc }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("aside", { className: "\n        fixed top-0 left-0 h-full\n        flex flex-col\n        bg-sidebar\n        text-sidebar-foreground\n        transition-all duration-500\n        w-(--sidebar-collapsed-width)\n        hover:w-(--sidebar-width)\n        z-50 group rounded-r-3xl pt-20 items-center\n      ", children: [_jsxs("div", { className: "flex flex-col items-center p-4 rounded-xl transition-all duration-300", children: [_jsx("img", { src: logoSrc, alt: "Logo", className: "w-8 h-8 group-hover:w-12 group-hover:h-12  shrink-0 transition-all duration-400" }), _jsxs("div", { className: "text-center flex flex-col gap-1 items-center", children: [_jsxs("p", { className: "mt-2 text-xl opacity-0 font-special font-semibold group-hover:opacity-100 transition-opacity duration-300 text-nowrap", children: [_jsx("span", { className: "text-sidebar-accent font-bold text-2xl", children: "C" }), "ircuit", " ", _jsx("span", { className: "text-sidebar-accent font-bold text-2xl", children: "C" }), "entral"] }), _jsx("p", { className: "mt-0 text-md opacity-0 italic text-sidebar-foreground group-hover:opacity-100 transition-opacity duration-300 text-nowrap", children: "Court Reporting Application" }), _jsx("p", { className: "mt-2 text-sm opacity-0 text-sidebar-accent group-hover:opacity-100 transition-opacity duration-300 text-nowrap", children: userName || "Guest" })] })] }), _jsx("div", { className: "flex flex-row w-full justify-center items-center mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300", children: _jsx(Toggle, { "aria-label": "Toggle light/dark mode", className: "data-[state=on]:bg-sidebar-accent", pressed: lightMode, onPressedChange: onToggleLightMode, children: _jsx(Lightbulb, {}) }) }), _jsx(Separator, { className: "group-hover:opacity-100 opacity-0 transition-opacity duration-500 mb-10" }), _jsx("nav", { className: "flex flex-col w-full items-left justify-start relative", children: routes.map((route) => {
