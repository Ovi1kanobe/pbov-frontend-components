...
export function SettingsNavigation({ activeSection, onSectionChange, navigationItems, userRole }) {
    const filteredItems = navigationItems.filter(item => !item.authorizedRoles || (item.authorizedRoles && item.authorizedRoles.includes(userRole)));
