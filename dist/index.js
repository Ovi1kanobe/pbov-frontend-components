...
function oauthProviderIcon(provider) {
  switch (provider.toLowerCase()) {
      ...
      return /* @__PURE__ */ jsxs13(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx39("path", { fill: "none", d: "M0 0h48v48H0z" })
          ]
        }
      );
    case "github":
      return /* @__PURE__ */ jsx39(
        "svg",
        {
          ...
          children: /* @__PURE__ */ jsxs13("g", { fill: "#161614", children: [
    ...
    case "facebook":
      return /* @__PURE__ */ jsx39("img", { src: "/auth/facebook.png", alt: "Facebook", className: "w-4 h-4" });
    case "microsoft":
      return /* @__PURE__ */ jsxs13(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsx39("title", { children: "Microsoft" }),
            /* @__PURE__ */ jsxs13("g", { children: [
              /* @__PURE__ */ jsx39("polygon", { fill: "#F1511B", points: "121.666095 121.666095 0 121.666095 0 0 121.666095 0" }),
              /* @__PURE__ */ jsx39(
                "polygon",
                {
                  fill: "#80CC28",
...
function OAuthButton({ provider, disabled, ...props }) {
  ...
  return /* @__PURE__ */ jsxs14(Button, { type: "button", className: "", variant: "outline", disabled, ...props, "aria-label": label, children: [
    icon ?? "error",
    label
  ] });
}
...
function AuthBackground() {
  return /* @__PURE__ */ jsxs15("div", { className: "fixed inset-0 z-10", children: [
    /* @__PURE__ */ jsx40(
      "div",
      {
        className: `wave`,
...
function AuthInput({
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "flex flex-col w-full h-10 relative", children: [
    /* @__PURE__ */ jsx41("div", { className: "bg-input rounded-md w-full h-10 relative z-10", children: /* @__PURE__ */ jsx41(
      "input",
      {
    ...
    /* @__PURE__ */ jsx41("div", { className: "absolute w-full h-full bg-accent-foreground/10 bottom-0 left-0 z-0 translate-y-0.5 rounded-lg" })
  ] });
}
function LoginPage({
  pb,
  ...
  const [username, setUsername] = React43.useState("");
  const [password, setPassword] = React43.useState("");
  const [loggedIn, setLoggedIn] = React43.useState(false);
  const [authMethods, setAuthMethods] = React43.useState(void 0);
  useEffect12(() => {
  ...
  return /* @__PURE__ */ jsxs16(
    "main",
    {
      ...
      children: [
        /* @__PURE__ */ jsx41(AuthBackground_default, {}),
        /* @__PURE__ */ jsxs16(
          "div",
          {
            className: cn(
            ...
            children: [
              logoSrc && /* @__PURE__ */ jsx41("img", { src: logoSrc, alt: "Logo", className: "w-40 mx-auto mb-4" }),
              /* @__PURE__ */ jsx41("p", { className: "text-muted-foreground text-center text-lg", children: "Unified Data for Court Reporting" }),
              /* @__PURE__ */ jsxs16(
                "form",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx41(Button, { type: "submit", className: "p-4", variant: "default", "aria-label": "Sign in with Email", children: "Sign in with Email" })
                  ]
                }
              ),
              authMethods?.oauth2?.providers?.map((provider) => {
                return /* @__PURE__ */ jsxs16(Fragment4, { children: [
                  /* @__PURE__ */ jsxs16("div", { className: "items-center justify-center mb-4 text-xs text-gray-500", children: [
                    /* @__PURE__ */ jsx41(Separator, { className: "mb-1 mt-4" }),
                    /* @__PURE__ */ jsx41("p", { className: "text-center", children: "OR CONTINUE WITH" }),
                    /* @__PURE__ */ jsx41(Separator, { className: "mt-1" })
                  ] }),
                  /* @__PURE__ */ jsx41(
                    OAuthButton,
                    {
