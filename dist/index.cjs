...
var buttonVariants = (0, import_class_variance_authority.cva)(
  "p-2 px-4 group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
...
function Select({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_radix_ui16.Select.Root, { "data-slot": "select", ...props });
}
function SelectGroup({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    import_radix_ui16.Select.Group,
    {
...
function SelectValue({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_radix_ui16.Select.Value, { "data-slot": "select-value", ...props });
}
function SelectTrigger({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(
    import_radix_ui16.Select.Trigger,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_radix_ui16.Select.Icon, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_lucide_react8.ChevronDownIcon, { className: "pointer-events-none size-4 text-muted-foreground" }) })
      ]
    }
  );
}
function SelectContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_radix_ui16.Select.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(
    import_radix_ui16.Select.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
          import_radix_ui16.Select.Viewport,
          {
...
function SelectLabel({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    import_radix_ui16.Select.Label,
    {
...
function SelectItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(
    import_radix_ui16.Select.Item,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("span", { className: "pointer-events-none absolute right-2 flex size-4 items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_radix_ui16.Select.ItemIndicator, { children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_lucide_react8.CheckIcon, { className: "pointer-events-none" }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_radix_ui16.Select.ItemText, { children })
      ]
    }
  );
}
function SelectSeparator({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    import_radix_ui16.Select.Separator,
    {
...
function SelectScrollUpButton({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    import_radix_ui16.Select.ScrollUpButton,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
        import_lucide_react8.ChevronUpIcon,
        {}
      )
    }
  );
...
function SelectScrollDownButton({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    import_radix_ui16.Select.ScrollDownButton,
    {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("path", { fill: "none", d: "M0 0h48v48H0z" })
          ]
        }
      );
    case "github":
    ...
    case "microsoft":
      return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("title", { children: "Microsoft" }),
            /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("polygon", { fill: "#F1511B", points: "121.666095 121.666095 0 121.666095 0 0 121.666095 0" }),
              /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
                "polygon",
                {
                  fill: "#80CC28",
...
function OAuthButton({ provider, disabled, ...props }) {
  const icon = oauthProviderIcon(provider);
  const label = provider.charAt(0).toUpperCase() + provider.slice(1);
  return /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)(Button, { type: "button", className: "", variant: "outline", disabled, ...props, "aria-label": label, children: [
    icon ?? "error",
    label
  ] });
}
...
function AuthBackground() {
  return /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)("div", { className: "fixed inset-0 z-10", children: [
...
var AuthBackground_default = AuthBackground;
...
function AuthInput({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "flex flex-col w-full h-10 relative", children: [
    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "bg-input rounded-md w-full h-10 relative z-10", children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
      "input",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("div", { className: "absolute w-full h-full bg-accent-foreground/10 bottom-0 left-0 z-0 translate-y-0.5 rounded-lg" })
  ] });
}
function LoginPage({
  pb,
  ...
  const [loggedIn, setLoggedIn] = import_react10.default.useState(false);
  const [authMethods, setAuthMethods] = import_react10.default.useState(void 0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(
    "main",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(AuthBackground_default, {}),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(
                "form",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(Button, { type: "submit", className: "p-4", variant: "default", "aria-label": "Sign in with Email", children: "Sign in with Email" })
                  ]
                }
              ),
              authMethods?.oauth2?.providers?.map((provider) => {
                return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)("div", { className: "items-center justify-center mb-4 text-xs text-gray-500", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(Separator, { className: "mb-1 mt-4" }),
                    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)("p", { className: "text-center", children: "OR CONTINUE WITH" }),
                    /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(Separator, { className: "mt-1" })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
                    OAuthButton,
                    {
